...
argument-hint: "[update|session <session-id>] [--plan PLAN] [--currency CODE]"
---
...
6. Support what-if comparisons by rerunning the calculator with `--plan`, `--currency`, and `--exchange-rate`.
